...
function Roadmaps() {
  ...
  <div className="container px-5 py-10 mx-auto cursor-pointer">
    <div className="flex flex-wrap -m-4">
      <RoadmapCard link="https://miro.com/app/board/uXjVPEAGfM8=/?share_link_id=921354111487" img="frontend.jpg" category="webdevelopment" heading="Front-End Devlopment" data="Everything you see on a website, like buttons, links, animations, and more, were created by a front end web developer. It is the front end developer's job to take the vision and design concept from the client and implement it through code."/>
